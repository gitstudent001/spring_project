...
public class CommentDTO {
	private Long comment_idx;					// 댓글 인덱스
	private Long post_id;							// 게시글 인덱스
  private Long user_idx;						// 작성자 인덱스
  private Long parent_comment_idx;  // 부모 댓글 인덱스, null 가능
